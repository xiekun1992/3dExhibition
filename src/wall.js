function Wall(){
	...
	this.rightGeometry = new THREE.BoxGeometry(0.1, 1, 10.9);
	...
	this.topGeometry = new THREE.BoxGeometry(0.1, 1, 10.5);
	...
	this.leftGeometry = new THREE.BoxGeometry(0.1, 1, 10.9);
	this.leftMesh = new THREE.Mesh(this.leftGeometry, this.material);
	this.leftMesh.position.set(-5.3, 0, -0.4);

	this.bottomGeometry = new THREE.BoxGeometry(0.1, 1, 10.5);
